    ...
    render() {
        return (
            <div>
                <NavBar />
                <TodoList />
                <Comment username='Test User 1'>This is a comment!</Comment>
                <Comment username='Test User 2'>This<br />is<br />a<br />comment<br />with<br />formatting<br />that<br />stretches<br />the<br />comment<br />block!'</Comment>
                <Comment username='Test User 2'><p>This is a lorem ipsum comment that just takes in a long string to ensure it stretches correctly.</p>
